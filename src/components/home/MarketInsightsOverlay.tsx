  ...
  return (
    <div className="container relative -mt-20 mb-12 z-10">
      <div className="grid md:grid-cols-3 gap-4">
        <Link to="/market-macrometer" className="transition-transform hover:scale-[1.02]">
          <Card className="bg-white/95 backdrop-blur h-full">
        ...
        <Link to="/market-sentiment" className="transition-transform hover:scale-[1.02]">
          <Card className="bg-white/95 backdrop-blur h-full">
            <CardHeader className="space-y-1">
              <div className="flex items-center justify-between">
        ...
        <Link to="/latest-earnings" className="transition-transform hover:scale-[1.02]">
          <Card className="bg-white/95 backdrop-blur h-full">
            <CardHeader className="space-y-1">
              <div className="flex items-center justify-between">
